...
@router.post("/", response_model=User, status_code=status.HTTP_201_CREATED, summary="新規ユーザー登録")
def register_user(
...
@router.post("/login", response_model=AuthResponse, summary="ユーザーログインとアクセストークン取得")
def user_login(
    user_in: UserLogin
) -> Any:
    """
